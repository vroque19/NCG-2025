...
void tmc5272_init(tmc5272_dev_t* tmc5272_dev)
{
	...
	tmc5272_writeRegister(tmc5272_dev, 0x04, 	0x60223B19, NULL); 		// writing value 0x60223B19 = 1612856089 = 0.0 to address 2 = 0x04(IOIN)
	tmc5272_writeRegister(tmc5272_dev, 0x05, 	0x0000000F, NULL); 		// writing value 0x0000000F = 15 = 0.0 to address 3 = 0x05(DRV_CONF)
	tmc5272_writeRegister(tmc5272_dev, 0x06, 	0x00000000, NULL); 		// writing value 0x00000000 = 0 = 0.0 to address 4 = 0x06(GLOBAL_SCALER)
	tmc5272_writeRegister(tmc5272_dev, 0x07, 	0x0000000F, NULL); 		// writing value 0x0000000F = 15 = 0.0 to address 5 = 0x07(RAMPMODE) <- HOLD M0 M1
	tmc5272_writeRegister(tmc5272_dev, 0x08, 	0x00000009, NULL); 		// writing value 0x00000009 = 9 = 0.0 to address 6 = 0x08(MSLUT_ADDR)
	...
	tmc5272_writeRegister(tmc5272_dev, 0x12, 	0x04041F08, NULL); 		// writing value 0x04041F08 = 67378952 = 0.0 to address 10 = 0x12(M0_IHOLD_IRUN)
	tmc5272_writeRegister(tmc5272_dev, 0x13, 	0x0000002B, NULL); 		// writing value 0x0000002B = 43 = 0.0 to address 11 = 0x13(M0_TPOWERDOWN)
	...
	tmc5272_writeRegister(tmc5272_dev, 0x18, 	0x026CA912, NULL); 		// writing value 0x026CA912 = 40675602 = 0.0 to address 15 = 0x18(M0_XACTUAL)
	...
	tmc5272_writeRegister(tmc5272_dev, 0x20, 	0x00000F8D, NULL); 		// writing value 0x00000F8D = 3981 = 0.0 to address 21 = 0x20(M0_AMAX)
	tmc5272_writeRegister(tmc5272_dev, 0x21, 	0x00000000, NULL); 		// writing value 0x00000000 = 0 = 0.0 to address 22 = 0x21(M0_VMAX)
	tmc5272_writeRegister(tmc5272_dev, 0x22, 	0x00000F8D, NULL); 		// writing value 0x00000F8D = 3981 = 0.0 to address 23 = 0x22(M0_DMAX)
